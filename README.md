...
Create a subscribe.dev app that generates pics of ducks. User enters a word, this word is appended to an image gen prompt that makes a duck with <user entered theme>
